...
import { code, createCodePlugin, type ThemeInput } from "../index";
...
describe("code", () => {
  ...
  describe("supportsLanguage", () => {
    ...
    it("should return false for unsupported languages", () => {
      ...
      expect(code.supportsLanguage("" as BundledLanguage)).toBe(false);
    });
  });
...
describe("highlight error handling", () => {
  it("should handle highlighting errors gracefully", async () => {
    ...
    const freshPlugin = createCodePlugin({
      themes: [
        "invalid-theme-that-does-not-exist" as ThemeInput,
        "another-invalid-theme" as ThemeInput,
      ],
    });
